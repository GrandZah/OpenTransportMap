...
from transport_posters.render_transport.render_stops import render_stops
...
@log_function_call
def render_detailed_map(stop_row: Series, ctx_map: CityRouteDatabase, layers: LayersMap,
